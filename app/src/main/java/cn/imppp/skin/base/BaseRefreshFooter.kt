...
class BaseRefreshFooter : LinearLayout, RefreshFooter {
    ...
    constructor(context: Context?, text: String?) : super(context) {
        ...
        val tvView = view.findViewById<TextView>(R.id.tvMore)
        tvView.text = text
        Log.i("currentMode", "${AppCompatDelegate.getDefaultNightMode()}")
        if (AppCompatDelegate.getDefaultNightMode() == AppCompatDelegate.MODE_NIGHT_YES) {
            tvView.setTextColor(context!!.resources.getColor(R.color.color_white))
        } else{
            tvView.setTextColor(context!!.resources.getColor(R.color.color_black))
        }
