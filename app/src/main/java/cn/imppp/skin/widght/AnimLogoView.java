...
public class AnimLogoView extends View {
    ...
    public AnimLogoView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.AnimLogoViewAttr);
        String logoName = ta.getString(R.styleable.AnimLogoViewAttr_logoName);
        isAutoPlay = ta.getBoolean(R.styleable.AnimLogoViewAttr_autoPlay, true);
        isShowGradient = ta.getBoolean(R.styleable.AnimLogoViewAttr_showGradient, false);
        mOffsetDuration = ta.getInt(R.styleable.AnimLogoViewAttr_offsetAnimDuration, ANIM_LOGO_DURATION);
        mGradientDuration = ta.getInt(R.styleable.AnimLogoViewAttr_gradientAnimDuration, ANIM_LOGO_GRADIENT_DURATION);
        mTextColor = ta.getColor(R.styleable.AnimLogoViewAttr_textColors, ANIM_LOGO_TEXT_COLOR);
        mGradientColor = ta.getColor(R.styleable.AnimLogoViewAttr_gradientColor, ANIM_LOGO_GRADIENT_COLOR);
        mTextPadding = ta.getDimensionPixelSize(R.styleable.AnimLogoViewAttr_textPadding, DEFAULT_TEXT_PADDING);
        mTextSize = ta.getDimensionPixelSize(R.styleable.AnimLogoViewAttr_textSize, ANIM_LOGO_TEXT_SIZE);
        mLogoOffset = ta.getDimensionPixelOffset(R.styleable.AnimLogoViewAttr_verticalOffset, 0);
        ta.recycle();
